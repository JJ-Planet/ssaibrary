...
public class InquiryController {
	...
	//글 작성
	@PostMapping
	public ResponseEntity<String> insertInquiry(@RequestBody InsertInquiryDTO i) throws NotFoundException{
		inquiryService.insertInquiry(i);
		return new ResponseEntity<String>(SUCCESS, HttpStatus.OK);
	}

	// 전체목록조회
	@GetMapping
	public ResponseEntity<Map<String, Object>> findAllInquiry() throws NotFoundException{
		return new ResponseEntity<Map<String,Object>>(inquiryService.findAllInquiry(), HttpStatus.ACCEPTED);
	}
	...
	//답변하기
	@PutMapping
	public ResponseEntity<String> answerInquiry(@RequestBody AnswerInquiryDTO i) throws NotFoundException{
		inquiryService.answerInquiry(i);
		return new ResponseEntity<String>(SUCCESS, HttpStatus.OK);
	}
